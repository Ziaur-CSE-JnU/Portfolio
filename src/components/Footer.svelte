...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> ziaur.ceh@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/Ziaur-CSE-JnU" target="_blank" class="text-violet-400"
                >Ziaur-CSE-JNU<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/ziacse/" target="_blank" class="text-violet-400"
                >Md. Ziaur Rahman<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
