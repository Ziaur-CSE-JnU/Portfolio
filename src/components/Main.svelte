    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Ziaur</span> Rahman
                <br />Cyber Security
                <span class="poppins text-violet-400">Analyst</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                A cybersecurity enthusiast with a passion for <span class="text-violet-400"> ethical hacking and penetration </span> testing. Seeking to leverage my skills and experience as a Cyber Security
                Analyst or Penetration Tester in a reputable organization.
            </p>
            <button
